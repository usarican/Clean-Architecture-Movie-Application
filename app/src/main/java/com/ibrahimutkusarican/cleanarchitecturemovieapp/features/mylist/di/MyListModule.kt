...
import com.ibrahimutkusarican.cleanarchitecturemovieapp.features.mylist.domain.usecase.AddMyListMovieUseCaseImpl
...
abstract class MyListModule {
    ...
    @Binds
    abstract fun bindAddMyListMovieUseCase(addMyListMovieUseCaseImpl: AddMyListMovieUseCaseImpl): AddMyListMovieUseCase

    @Binds
    abstract fun bindDeleteMyListMovieUseCase(deleteMyListMovieUseCaseImpl: DeleteMyListMovieUseCaseImpl): DeleteMyListMovieUseCase
