package com.ibrahimutkusarican.cleanarchitecturemovieapp.ui.theme
import androidx.compose.ui.graphics.Color

/**
 * Summary of Usage
 * Color	Use Case
 * primaryLight	Buttons, App Bars, Icons
 * onPrimaryLight	Text on primary-colored backgrounds
 * secondaryLight	Secondary Buttons, Chips
 * onSecondaryLight	Text on secondary-colored backgrounds
 * backgroundLight	Activity/Fragment background
 * surfaceLight	Card, Dialog background
 * errorLight	Error messages, Error icons
 * outlineLight	Borders, Dividers
 *
 */
